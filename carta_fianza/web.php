...
Route::controller(App\Http\Controllers\Modulo\Controlcalidad\Procesos\AnalisistendenciaController::class)->middleware('jwt.verify')->group(function () {
    ...
    // Para Laravel
    Route::post('controlcalidad/procesos/analisistendencia/obtenerDatosGrafico', [App\Http\Controllers\Modulo\Controlcalidad\Procesos\AnalisistendenciaController::class, 'obtenerDatosGrafico'])->name('obtenerDatosGrafico');
    //Route::post('controlcalidad/procesos/protocoloanalisis/swagger/signin', [AcsignerController::class, 'signin'])->name('swaggerSignin');
    //Route::post('controlcalidad/procesos/protocoloanalisis/swagger/upload-pdf', [AcsignerController::class, 'uploadPdf'])->name('swaggerUpload');
    // Añadir esta ruta en tu archivo de rutas
    Route::post('controlcalidad/procesos/analisistendencia/exportarPDF', [
        App\Http\Controllers\Modulo\Controlcalidad\Procesos\AnalisistendenciaController::class,
        'exportarGraficoPDF'
    ]);
