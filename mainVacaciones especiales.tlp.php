        ...
        <div class="row">
            <div class="panel panel-ac" style="margin-bottom:0px;">
                <div class="panel-heading" id="panel_body_title">
                    <h3 class="panel-title text-center">Gestión de Registro Especial</h3>
                </div>
            </div>
            <div class="filtering">
                <form class="">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="qry_colaborador" id="qry_colaborador" class="form-control selectpicker with-ajax" data-live-search="true">
                            </select>
                        </div>
                        <div class="col-sm-6 form-group">
