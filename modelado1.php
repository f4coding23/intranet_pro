                ...
                <table class="min-w-full text-left">
                    <thead class="border-b bg-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-2 text-gray-700 uppercase text-sm font-medium">REGISTRADOR</th>
                            <th scope="col" class="px-4 py-2 text-gray-700 uppercase text-sm font-medium">FECHA DE REGISTRO</th>
                            <th scope="col" class="px-4 py-2 text-gray-700 uppercase text-sm font-medium">ACCIÓN</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- Fila sin datos -->
